...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fits2image-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fits2image-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install fits2image
```
...
It is possible to list all of the versions of `fits2image` available on your platform:
...
```
pixi search fits2image --channel conda-forge
```
